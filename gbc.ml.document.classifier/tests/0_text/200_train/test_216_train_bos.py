...
class TestDoTraining(unittest.TestCase):
    ...
    def test_training_boosting_ada_by_text(self):
        self.assertTrue(
            ITest.do_request(
    ...
    def test_training_boosting_sgd_by_text(self):
        self.assertTrue(
            ITest.do_request(
                server_url=os.path.join(CLIENT_URL, conf.client_training),
                action=ClassifyService.TRAIN,
...
def suite_train():
    ...
    suite.addTest(TestDoTraining("test_training_boosting_ada_by_text"))
    suite.addTest(TestDoTraining("test_training_boosting_sgd_by_text"))
    return suite
