...
class TestDoPrediction(unittest.TestCase):
    ...
    def test_311_text_prediction_file_bagging(self):
        self.assertTrue(
            ITest.do_request(
    ...
    def test_29_text_prediction_file_decision_tree(self):
        self.assertTrue(
            ITest.do_request(
                server_url=os.path.join(CLIENT_URL, conf.client_predict),
                action=ClassifyService.PREDICT,
    ...
    def test_33_text_prediction_file_random_forest(self):
        self.assertTrue(
            ITest.do_request(
                server_url=os.path.join(CLIENT_URL, conf.client_predict),
                action=ClassifyService.PREDICT,
...
def suite_prediction():
    ...
    suite.addTest(TestDoPrediction("test_311_text_prediction_file_bagging"))
    ...
    suite.addTest(TestDoPrediction("test_29_text_prediction_file_decision_tree"))
    ...
    suite.addTest(TestDoPrediction("test_33_text_prediction_file_random_forest"))
    return suite
