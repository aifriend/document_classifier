...
class TestDoPrediction(unittest.TestCase):
    ...
    def test_309_prediction_file_voting(self):
        self.assertTrue(
            ITest.do_request(
                ...
                model=ClassifyService.ALL_VOTING).status_code == 200
        )


def suite_prediction():
    suite = unittest.TestSuite()
    suite.addTest(TestDoPrediction("test_309_prediction_file_voting"))
    return suite
