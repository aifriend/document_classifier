...
class GbcMlDocumentClassifierTrainingResource(Resource):
    ...
    trainRequest = api.model('TrainRequest', {
        ...
        'model': fields.String(required=True, description='Source of classifier (BAGGING)'),
        ...
        try:
            ...
            if source == ClassifyFactory.PLAINTEXT:
                ...
                if mode == ClassifyFactory.TEXT:
                    ...
                    self.logger.Error("Unsuitable type. Should be: TEXT")
                ...
                if mode == ClassifyFactory.TEXT:
                    ...
                    self.logger.Error("Unsuitable type. Should be: TEXT | IMAGE")
