...
from GbcMlDocumentClassifierPrediction import GbcMlDocumentClassifierPrediction
from GbcMlDocumentClassifierTrainingResource import GbcMlDocumentClassifierTrainingResource

ns.add_resource(GbcMlDocumentClassifierTrainingResource, '/training')
ns.add_resource(GbcMlDocumentClassifierPrediction, '/predict')
